 ...
 *
 * 입력
 * 첫째 줄에 로그에 기록된 출입 기록의 수 n이 주어진다. (2 ≤ n ≤ 1,000,000)
 *
 * 다음 n개의 줄에는 출입 기록이 순서대로 주어지며,
 * 각 줄에는 사람의 이름과 "enter" 또는 "leave"가 주어진다.
 * "enter"는 출근, "leave"는 퇴근을 의미한다.
 *
 * 회사에는 동명이인이 없으며,
 * 대소문자가 다른 경우에는 서로 다른 이름으로 구분한다.
 * 사람들의 이름은 알파벳 대소문자로 구성된 길이 5 이하의 문자열이다.
 *
 * 출력
